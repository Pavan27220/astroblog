...
{
   images[i-1].setAttribute("src","../ASSET/IMAGE/asteroids/"+i+".jpg")
...
function inc()
{
    ...
    {
        indval = 0;
    document.getElementById("header").style.backgroundImage="url(../ASSET/IMAGE/asteroids/"+imgarr[indval]+")"
    }
    else
    {
    document.getElementById("header").style.backgroundImage="url(../ASSET/IMAGE/asteroids/"+imgarr[indval]+")"
...
function openImg(pic,name,info)
{
    ...
    document.getElementById("subWindowImg").src='../ASSET/IMAGE/asteroids/'+pic+'.jpg'
